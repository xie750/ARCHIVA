    ...
    <section id="featured" class="container">
      ...
      <div class="national-overview-grid">
        ...
        <div class="overview-side">
          ...
          <RouterLink to="/atlas" class="mini-card overview-action"><div><MapPin :size="24" color="#a73e32" /><h3>打开全国地图</h3><p>进入全屏三维图谱，旋转全国地图，点击城市节点查看建筑详情。</p></div><span class="link-arrow">进入三维图谱 <ArrowRight :size="15" /></span></RouterLink>
        </div>
      </div>
    </section>
