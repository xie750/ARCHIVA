...
export const buildings: Building[] = [
  {
    ...
    image: {
      src: commonsImage('27427-Luoyang_(49067744628).jpg'),
      alt: '龙门石窟奉先寺崖壁造像实景',
      credit: 'Gary Todd / Wikimedia Commons',
      license: 'CC0 1.0',
      sourceUrl: 'https://commons.wikimedia.org/wiki/File:27427-Luoyang_(49067744628).jpg',
      position: '50% 38%',
    },
    accent: '#b94335',
  ...
  },
  {
    ...
    image: {
      src: commonsImage('Shaolin_Temple_(10199450903).jpg'),
      alt: '嵩山少林寺山门与寺院实景',
      credit: 'William Cho / Wikimedia Commons',
      license: 'CC BY-SA 2.0',
      sourceUrl: 'https://commons.wikimedia.org/wiki/File:Shaolin_Temple_(10199450903).jpg',
      position: '50% 48%',
    },
    accent: '#7c694a',
  ...
  },
  {
    ...
    image: {
      src: commonsImage('Iron_Pagoda_Cropped.jpg'),
      alt: '开封铁塔塔身实景',
      credit: 'Charlie Fong / Wikimedia Commons',
      license: 'CC BY-SA 4.0',
      sourceUrl: 'https://commons.wikimedia.org/wiki/File:Iron_Pagoda_Cropped.jpg',
      position: '50% 22%',
    },
    accent: '#a76b3d',
  ...
  },
  {
    ...
    image: {
      src: commonsImage('20231119_Yingtian_Gate_04.jpg'),
      alt: '洛阳应天门遗址展示建筑夜间实景',
      credit: 'N509FZ / Wikimedia Commons',
      license: 'CC BY-SA 4.0',
      sourceUrl: 'https://commons.wikimedia.org/wiki/File:20231119_Yingtian_Gate_04.jpg',
      position: '50% 44%',
    },
    accent: '#9d302c',
  ...
  },
  {
    ...
    image: {
      src: commonsImage('Small_Bridge_at_Qingming_Riverside_Landscape_Garden,_Kaifeng,_China.jpg'),
      alt: '开封清明上河园桥梁与水岸建筑实景',
      credit: 'Vmenkov / Wikimedia Commons',
      license: 'CC BY-SA 3.0',
      sourceUrl: 'https://commons.wikimedia.org/wiki/File:Small_Bridge_at_Qingming_Riverside_Landscape_Garden,_Kaifeng,_China.jpg',
      position: '50% 48%',
    },
    accent: '#54715f',
  ...
  },
  {
    ...
    coverClass: 'cover-pagoda',
    image: {
      src: commonsImage('Pagodaoffogongtemple2019.jpg'),
      alt: '应县佛宫寺释迦塔木构塔身实景',
      credit: 'Zhangzhugang / Wikimedia Commons',
      license: 'CC BY-SA 4.0',
      sourceUrl: 'https://commons.wikimedia.org/wiki/File:Pagodaoffogongtemple2019.jpg',
      position: '50% 26%',
    },
    accent: '#8d6042',
  ...
  },
  {
    ...
    coverClass: 'cover-pagoda',
    image: {
      src: commonsImage('Giant_Wild_Goose_Pagoda.jpg'),
      alt: '西安大雁塔砖塔实景',
      credit: 'Citycat / Wikimedia Commons',
      license: 'CC BY-SA 3.0',
      sourceUrl: 'https://commons.wikimedia.org/wiki/File:Giant_Wild_Goose_Pagoda.jpg',
      position: '50% 30%',
    },
    accent: '#a06b42',
  ...
  },
  {
    ...
    coverClass: 'cover-gate',
    image: {
      src: commonsImage('First_Pass_Under_Heaven_天下第一关_(6234529540).jpg'),
      alt: '山海关天下第一关镇东楼城门实景',
      credit: 'Dan Lundberg / Wikimedia Commons',
      license: 'CC BY-SA 2.0',
      sourceUrl: 'https://commons.wikimedia.org/wiki/File:First_Pass_Under_Heaven_%E5%A4%A9%E4%B8%8B%E7%AC%AC%E4%B8%80%E5%85%B3_(6234529540).jpg',
      position: '50% 44%',
    },
    accent: '#9b563a',
  ...
  },
  {
    ...
    coverClass: 'cover-shaolin',
    image: {
      src: commonsImage('曲阜孔廟大成殿.jpg'),
      alt: '曲阜孔庙大成殿实景',
      credit: 'Wikimedia Commons contributors',
      license: 'Creative Commons',
      sourceUrl: 'https://commons.wikimedia.org/wiki/File:%E6%9B%B2%E9%98%9C%E5%AD%94%E5%BB%9F%E5%A4%A7%E6%88%90%E6%AE%BF.jpg',
      position: '50% 45%',
    },
    accent: '#806748',
  ...
  },
  {
    ...
    coverClass: 'cover-garden',
    image: {
      src: commonsImage('Yixian_Hongcun_2016.09.09_17-27-03.jpg'),
      alt: '安徽宏村南湖与徽派建筑实景',
      credit: 'Vmenkov / Wikimedia Commons',
      license: 'CC BY-SA 4.0',
      sourceUrl: 'https://commons.wikimedia.org/wiki/File:Yixian_Hongcun_2016.09.09_17-27-03.jpg',
      position: '50% 54%',
    },
    accent: '#55766b',
  ...
  },
  {
    ...
    coverClass: 'cover-pagoda',
    image: {
      src: commonsImage('CN_-_Hubei_-_Wuhan_-_Kranichpagode.jpg'),
      alt: '武汉黄鹤楼主楼实景',
      credit: 'CEphoto, Uwe Aranas / Wikimedia Commons',
      license: 'CC BY-SA 3.0',
      sourceUrl: 'https://commons.wikimedia.org/wiki/File:CN_-_Hubei_-_Wuhan_-_Kranichpagode.jpg',
      position: '50% 34%',
    },
    accent: '#a35e38',
    ...
    scenic: {
      ...
      points: [{ id: 'yellow-crane-main', name: '黄鹤楼主楼', subtitle: '清式形制复建名楼', description: '模型聚焦五层楼体的层叠出檐、红柱黄瓦和临江观景关系，单独呈现名楼而非通用塔形。', position: [50, 50], coordinates: [114.3055, 30.5440], modelKind: 'pavilion', status: '重点展项', useParentModel: true }],
    },
    status: '持续研究',
